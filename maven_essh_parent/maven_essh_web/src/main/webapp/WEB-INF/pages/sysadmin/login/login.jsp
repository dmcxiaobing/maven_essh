...
<script language="javascript">
	...
	function checkform() {
		...
		if (f.userName.value == "" || f.userName.value.replace(/\s+/, '') == '') {
			alert("用户名不能为空!")
			f.userName.focus();
			return false;
		}
		if (f.password.value == "" || f.password.value.replace(/\s+/, '') == '') {
			alert("密码不能为空!")
			f.password.focus();
			return false;
			...
			<div class="box">
				<div class="inputstyle">
					<div class="inputlable">
						用户名： <input type="text" value="${userName}" name="username"
							id="userName" onFocus="this.select();" title="请您输入用户名" />
				...
				<div class="btnstyle">
					<input class="loginImgOut" value="" type="button"
						...
						/> <input class="resetImgOut"
						value="" type="button" onmouseover="this.className='resetImgOver'"
